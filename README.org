...
Use =systemd-creds= with the =--user switch= to create a user credential to encrypt your password. This ties the credential to your machine and doesn't require GPG. This *does not* require root privlages.
